...
/**
 * Bean definitions for {@link InvestigadorRepository}.
 */
@Generated
public class InvestigadorRepository__BeanDefinitions {
  /**
   * Get the bean instance supplier for 'investigadorRepository'.
   */
  private static BeanInstanceSupplier<JpaRepositoryFactoryBean> getInvestigadorRepositoryInstanceSupplier(
      ) {
  ...
  /**
   * Get the bean definition for 'investigadorRepository'.
   */
  public static BeanDefinition getInvestigadorRepositoryBeanDefinition() {
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragments", new RuntimeBeanReference("jpa.InvestigadorRepository.fragments#0"));
