...
/**
 * Bean definitions for {@link AuditoriaRepository}.
 */
@Generated
public class AuditoriaRepository__BeanDefinitions {
  /**
   * Get the bean instance supplier for 'auditoriaRepository'.
   */
  private static BeanInstanceSupplier<JpaRepositoryFactoryBean> getAuditoriaRepositoryInstanceSupplier(
      ) {
  ...
  /**
   * Get the bean definition for 'auditoriaRepository'.
   */
  public static BeanDefinition getAuditoriaRepositoryBeanDefinition() {
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragments", new RuntimeBeanReference("jpa.AuditoriaRepository.fragments#0"));
